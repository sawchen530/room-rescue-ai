...
**Status: scaffolding only.** Room Rescue is not submitted, not in review, and not on either store. Use this list when Jeff has accounts and a Mac.
...
Keep this aligned with the web product. Do not claim a professional inspection, guaranteed list, or that photos stay on-device.

**Name:** Room Rescue  
**Subtitle (Apple, 30 characters):** Photograph a room. Get a list.  
**Short description (Play, 80 characters):** Photograph a room. Get a DIY fix-up list. Not a professional inspection.

**Description (draft):**

> Photograph a room. Room Rescue drafts a practical checklist for what to clean, fix, organize, or inspect — then you can take an after photo to check progress.
>
> Built for DIY homeowners. No account, no payments, no photo library.
>
> The list is generated by an AI vision model from what is visible in your photo. It can miss things or be wrong. Trust the room. This is not a licensed inspection or professional advice. Stop and call a qualified person for electrical, gas, structural, water, or anything that feels unsafe.
>
> Photos are sent to our server in memory, then to OpenAI to analyze the room. We do not keep your photos as a product feature.

**Keywords (Apple, draft):** room, clean, checklist, home, DIY, organize, repair, photo  
**Category:** Lifestyle (or Productivity). Not Kids.  
**Support URL:** the Railway site or a GitHub Issues URL Jeff chooses  
**Marketing URL:** optional — the live site is enough
...
6. Fill the listing, privacy nutrition label, age rating, review notes, and screenshots.
...
- Launch storyboard / splash placeholders
...
Capture on a **physical device or Xcode simulator** at the sizes App Store Connect currently requires (Apple changes the exact pixel list). Typical 2026 set:

| Device class | Common size (portrait) | How many |
| --- | --- | --- |
| iPhone 6.9" / 6.7" (required) | 1320×2868 or 1290×2796 | 3–10 |
| iPhone 6.5" (often still required) | 1284×2778 | 3–10 |
| iPad 13" / 12.9" if you offer iPad | 2064×2752 or 2048×2732 | 3–10 |

Minimum useful shots (same story as the web):

1. Home — “Start with a photo” + sample-room control
2. A generated checklist (sample room is fine)
3. After-photo / progress comparison, or the empty after-photo step
4. Privacy or Terms (optional; honesty helps review)

Do not use marketing mockups that imply a different product. Dark olive + cream UI is already the brand.
...
| --- | --- |
| High-res icon | 512×512 PNG (replace the placeholder) |
| Feature graphic | 1024×500 |
| Phone screenshots | at least 2, up to 8; 16:9 or 9:16 |
| 7" / 10" tablet | optional unless you claim tablet support |
| Short / full description | see listing copy above |

Same four storyboards as iOS are enough.
...
4. **Icons / splash** in `native/assets/` are placeholders. Replace before submission.
